...
public class SalesInvoiceTable {
    ...
    private List<NegBatchWindowTableDTO> batchWindowTableDTOList;
    ...
    public List<NegBatchWindowTableDTO> getBatchWindowTableDTOList() {
        return batchWindowTableDTOList;
    }

    public void setBatchWindowTableDTOList(List<NegBatchWindowTableDTO> batchWindowTableDTOList) {
    ...
    public String toString(){
        ...
        float floatValue = !quantity.getValue().isEmpty() ? Float.parseFloat(quantity.getValue()) : 0;
    ...
    /**
     * @ImplNote : Unit wise rate pick for AI - withBatch & without batch sales Invoice
     * **/
