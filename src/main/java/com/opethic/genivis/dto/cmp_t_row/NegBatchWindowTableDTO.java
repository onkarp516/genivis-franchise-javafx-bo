...
public class NegBatchWindowTableDTO {
    ...
    public NegBatchWindowTableDTO() {

    }


    public NegBatchWindowTableDTO(String currentIndex, String productId, String levelAId, String levelBId, String levelCId, String unitId, String tax, String batchNo,
                                  String manufacturingDate, String expiryDate, String mrp, String purchaseRate, String quantity, String free,
                                  String discountPercentage, String discountAmount, String barcode, String margin, String fsr_mh, String csr_mh,
                                  String fsr_ai, String csr_ai, String b_details_id, String supplier_id, String action) {
    ...
    public NegBatchWindowTableDTO(String currentIndex, String productId, String levelAId, String levelBId, String levelCId, String unitId, String tax, String batchNo,
                                  String manufacturingDate, String expiryDate, String mrp, String purchaseRate, String quantity, String free,
                                  String discountPercentage, String discountAmount, String barcode, String margin, String fsr_mh, String csr_mh,
                                  String fsr_ai, String csr_ai, String b_details_id, String supplier_id, String action, String unit) {
        this.currentIndex = new SimpleStringProperty(currentIndex);
        this.productId = new SimpleStringProperty(productId);
        this.levelAId = new SimpleStringProperty(levelAId);
        this.levelBId = new SimpleStringProperty(levelBId);
    ...
    public Boolean getIsNegetiveAllowedUnitWise(String unitId) {
        boolean rtnNegetiveAllow = false;
        if (selectedProduct != null) {
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit1Id() + "")) {
                rtnNegetiveAllow = selectedProduct.getUnit1IsNegetive();
            }
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit2Id() + "")) {
                rtnNegetiveAllow = selectedProduct.getUnit2IsNegetive();
            }
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit3Id() + "")) {
                rtnNegetiveAllow = selectedProduct.getUnit3IsNegetive();
            }
        }

        return rtnNegetiveAllow;
    }

    public String getPurchaseRateUnitWise(String unitId) {
        Double rtnValue = 0.0;
        if (selectedProduct != null) {
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit1Id() + "")) {
                rtnValue = selectedProduct.getUnit1PurchaseRate();
            }
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit2Id() + "")) {
                rtnValue = selectedProduct.getUnit2PurchaseRate();
            }
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit3Id() + "")) {
                rtnValue = selectedProduct.getUnit3PurchaseRate();
            }
        }
    ...
    public String getMrpUnitWise(String unitId) {
        Double rtnValue = 0.0;
        if (selectedProduct != null) {
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit1Id() + "")) {
                rtnValue = selectedProduct.getUnit1Mrp();
            }
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit2Id() + "")) {
                rtnValue = selectedProduct.getUnit2Mrp();
            }
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit3Id() + "")) {
                rtnValue = selectedProduct.getUnit3Mrp();
            }
        }
        return String.valueOf(rtnValue);
    }

    public String getFsrMHUnitWise(String unitId) {
        Double rtnValue = 0.0;
        if (selectedProduct != null) {
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit1Id() + "")) {
                rtnValue = selectedProduct.getUnit1FSRMH();
            }
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit2Id() + "")) {
                rtnValue = selectedProduct.getUnit2FSRMH();
            }
            if (unitId.equalsIgnoreCase(selectedProduct.getUnit3Id() + "")) {
                rtnValue = selectedProduct.getUnit3FSRMH();
            }
        }
        return String.valueOf(rtnValue);
    }
