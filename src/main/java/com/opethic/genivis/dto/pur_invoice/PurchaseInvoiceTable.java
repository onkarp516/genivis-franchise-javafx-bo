...
public class PurchaseInvoiceTable {
    ...
    private SimpleStringProperty b_barcode = new SimpleStringProperty("");
    ...
    public String getB_barcode() {
        return b_barcode.get();
    }

    public SimpleStringProperty b_barcodeProperty() {
        return b_barcode;
    }

    public void setB_barcode(String b_barcode) {
        this.b_barcode.set(b_barcode);
    }
    ...
    public String toString() {
        ...
        jsonObject.addProperty("barcode", b_barcode.getValue());
